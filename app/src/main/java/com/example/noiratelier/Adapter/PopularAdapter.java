...
import com.example.noiratelier.Activity.DetailActivity;
import com.example.noiratelier.Domain.ItemsModel;
import com.example.noiratelier.databinding.ViewholderCategoryBinding;
import com.example.noiratelier.databinding.ViewholderPopularBinding;
...
public class PopularAdapter extends RecyclerView.Adapter<PopularAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull PopularAdapter.Viewholder holder, int position) {
        ...
        Glide.with(context)
                .load(items.get(position).getPicUrl().get(0)).apply(new RequestOptions().transform(new CenterInside())).into(holder.binding.pic);
